...
impl CPU6502 {
    ...
    /// 0x69, 0x65, 0x75, 0x6D, 0x7D, 0x79, 0x61, 0x71  - Add with Carry
    ...
    /// 0x29, 0x25, 0x35, 0x2D, 0x3D, 0x39, 0x21, 0x31 - Bitwise AND with Accumulator
    ...
    /// 0x0A, 0x06, 0x16, 0x0E, 0x1E - Arithmetic Shift Left
    ...
    fn dec(&mut self, mode: OperandMode, do_cmp: bool) -> u8 {
        let (address, value, cycles) = match mode {
            ZeroPage => {
                let (address, value) = self.zero_page();
                (address, value, 5)
            }
    ...
    /// 0x49, 0x45, 0x55, 0x4D, 0x5D, 0x59, 0x41, 0x51 - Bitwise Exclusive OR
    ...
    /// 0x4A, 0x46, 0x56, 0x4E, 0x5E - Logical Shift Right
    ...
    /// 0x09, 0x05, 0x15, 0x0D, 0x1D, 0x19, 0x01, 0x11 - Bitwise OR with Accumulator
    ...
    /// 0x2A, 0x26, 0x36, 0x2E, 0x3E - Rotate Left
    ...
    /// 0x6A, 0x66, 0x76, 0x6E, 0x7E - Rotate Right
    ...
    /// 0xE9, 0xE5, 0xF5, 0xED, 0xFD, 0xF9, 0xE1, 0xF1 - Subtract with Carry
    ...
    /// 0xA9, 0xA5, 0xB5, 0xAD, 0xBD, 0xB9, 0xA1, 0xB1 - Load Accumulator
    ...
    /// 0xA2, 0xA6, 0xB6, 0xAE, 0xBE - Load X
    ...
    /// 0xA0, 0xA4, 0xB4, 0xAC, 0xBC - Load Y
    ...
    /// 0x85, 0x95, 0x8D, 0x9D, 0x99, 0x81, 0x91 - Store Accumulator
    ...
    /// 0x86, 0x96, 0x8E - Store X Register
    ...
    /// 0x84, 0x94, 0x8C - Store Y Register
